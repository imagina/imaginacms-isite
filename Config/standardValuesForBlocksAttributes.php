...
return [
    ...
    "marginX" => [
        ["label" => "0", "value" => "mx-0"],
        ["label" => "4px", "value" => "mx-1"],
        ["label" => "8px", "value" => "mx-2"],
        ["label" => "16px", "value" => "mx-3"],
        ["label" => "24px", "value" => "mx-4"],
        ["label" => "48px", "value" => "mx-5"]
    ],
    ...
    "dotStyle" => [
        ...
        ["label" => "Circulos", "value" => "dots-linear"]
    ]
];