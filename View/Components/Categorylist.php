...
class CategoryList extends Component
{
  ...
  public function __construct($params, $layout, $showDescription = false,
                              $columns = ['col-12 col-md-6', 'col-12 col-md-6', 'col-12 col-md-5', 'col-12 col-md-7'])
  {
    $this->params = $params;
    $this->layout = $layout;
    $this->view = "isite::frontend.components.category-list.layouts.$layout.index";
  ...
  {
    return view('isite::frontend.components.category-list');
  }
