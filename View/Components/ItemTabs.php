...
class ItemTabs extends Component
{
   ...
   * @return void
   */
  public function __construct($settingTabs = null, $componentUse = 'item-list', $title = null, $subtitle = null,
                              $componentParams = null, $componentRepository = 'Modules\Iblog\Repositories\PostRepository',
                              ...
                              $componentConfigLayoutIndex = [], $componentItemComponentAttributes = [],
