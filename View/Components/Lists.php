...
class Lists extends Component
{
   ...
   * @return void
   */
  public function __construct($repository, $class = null, $params = [], $id = 'lists', $buttonTitle = 'Ver Más',
                              $margin = 10, $layout = 'lists-layout-1', $title = "", $subTitle = "", $view = null,
                              $columnLeft = "col-lg-8", $columnRight = "col-lg-4", $orderColumnMain = 0,
                              $preListContentView = "", $postListContentView = "", $titleAlign = "text-left",
                              $titleLineMarginY = "mt-3 mb-4", $titleColor = null, $titleVineta = null,
                              $titleVinetaColor = null, $titleSize = null, $titleWeight = "font-weight-normal",
                              $titleTransform = null, $titleLetterSpacing = 0, $itemComponent = null,
                              $itemComponentAttributesMain = [], $itemComponentAttributesList = [],
                              $itemComponentNamespace = null, $titleUrl = null, $titleTarget = "_self",
                              $itemLayout = null, $itemComponentAttributes = [], $subtitle = "", $subtitleSize = null,
