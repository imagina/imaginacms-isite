...
class OwlCarousel extends Component
{
   ...
   * @return void
   */
  public function __construct($repository, $id, $view = null, $params = [], $margin = 10, $responsiveClass = true,
                              ...
                              $navPosition = 'bottom', $navSizeLabel = '20', $dotsStyle = 'linear',
                              $navColor = 'primary', $navSizeButton = '', $navStyleButton = '', $owlTextPosition = 1,
                              ...
                              $owlSubtitleLetterSpacing = 0, $componentItemAttributes = [], $stagePadding = 0)
  {
