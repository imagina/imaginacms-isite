...
class Social extends Component
{
  ...
  public function __construct($layout = 'social-layout-1', $type = '', $customIcons = [], $id = 'socialComponent',
                              $whatsappAttributes = [], $size = 'lg', $central = false, $withWhatsapp = true,
                              $iconSize = '16px', $iconBackgroundSize = '40px', $iconColor1 = 'var(--primary)',
                              $iconColor2 = '', $iconBorderRadius = '0', $iconBorderWidth = '0', $iconDisplay = 'flex',
                              $iconStyle = '', $iconBorderRadiusType = '1', $iconBoxShadow = '', $iconTextShadow = '',
                              $iconMargin = '0 0 5px  0', $iconAnimate = '', $idSocial = ''
  )
  {
    ...
    $this->whatsappAttributes = is_array($whatsappAttributes) && count($whatsappAttributes) > 0 ?
      $whatsappAttributes : ['size' => $this->size, 'type' => $this->type];
  }
