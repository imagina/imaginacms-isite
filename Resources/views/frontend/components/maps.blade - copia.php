<div class="component-map map-{{$settingMap}}">
  ...
  <script>
    ...
    //Custom Name Event
    //Esto genera problemas con las variables
    /*
    @if(!is_null($extraIdEvents))
      var listenerNameItemsUpdated = "items-map-updated-{{$extraIdEvents}}"
    @else
      var listenerNameItemsUpdated = 'items-map-updated'
    @endif
    console.warn(listenerNameItemsUpdated)
    */
