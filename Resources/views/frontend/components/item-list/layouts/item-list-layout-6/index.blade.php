    ...
    <div class="row align-items-center">
      ...
      <div class="col-12 {{$orderClasses["title"] ?? 'order-1'}} item-title ">
          ...
          <a href="{{$item->url}}" target="{{$target}}" class="{{$titleColor}}">
            ...
            <h3 class="title d-flex {{$item->url==="" ? $titleColor : '' }} {{$titleAlignVertical}} {{$titleAlign}} {{$titleTextWeight}} {{$titleTextTransform}}  {{$titleMarginT}} {{$titleMarginB}} {{$contentMarginInsideX}}" style="height: @if($titleHeight) {{$titleHeight}}px @else auto @endif;">
