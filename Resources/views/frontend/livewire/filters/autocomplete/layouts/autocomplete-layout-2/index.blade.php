<div id="autocompleteLayout2">
  ...
  <a id="tagHelper" data-toggle="collapse" href="#entityS" role="button" aria-expanded="false" aria-controls="entityS" class="collapsed d-none"></a>
  <div class=" collapse {{$collapsable}} multi-collapse position-absolute bg-white" id="entityS" style="     top: 110%;
    ...
    <div class="col-12 col-md-6 col-lg-3">
      @endif
      <input type="radio" class="d-none" id="item{{$word}}" value="{{$word}}" wire:click="collapsableInputClick('{{$word}}')">
      <label for="item{{$word}}" class="@if(in_array($word,$featuredOptions))font-weight-bold @endif">{{$word}}</label>
