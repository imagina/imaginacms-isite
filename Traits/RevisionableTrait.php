...
use Modules\Isite\Entities\Revision as Revisionable;
    ...
    public function preSave()
    {
        if (! isset($this->revisionEnabled) || $this->revisionEnabled) {
            ...
            foreach ($this->updatedData as $key => $val) {
                ...
                if (isset($this->casts[$key]) && in_array(gettype($val), $castCheck) &&
        ...
        foreach ($this->dirtyData as $key => $value) {
            ...
            if ($this->isRevisionable($key) && ! is_array($value)) {
                if (! array_key_exists($key, $this->originalData) || $this->originalData[$key] != $this->updatedData[$key]) {
                    ...
                    //dd('Data',$value,$this->originalData,$this->updatedData,$this);
                }
            } else {
